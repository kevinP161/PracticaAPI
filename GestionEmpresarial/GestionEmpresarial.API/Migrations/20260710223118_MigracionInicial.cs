        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Titulo_Conocimiento = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Area_Conocimiento = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nombre_proyecto = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NombreTecnico = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TecnicoId = table.Column<int>(type: "int", nullable: false),
                    ConocimientoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tecnico_Conocimientos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tecnico_Conocimientos_Conocimientos_ConocimientoId",
                        column: x => x.ConocimientoId,
                        principalTable: "Conocimientos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tecnico_Conocimientos_Tecnicos_TecnicoId",
                        column: x => x.TecnicoId,
                        principalTable: "Tecnicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tecnico_Conocimientos_ConocimientoId",
                table: "Tecnico_Conocimientos",
                column: "ConocimientoId");

            migrationBuilder.CreateIndex(
                name: "IX_Tecnico_Conocimientos_TecnicoId",
                table: "Tecnico_Conocimientos",
                column: "TecnicoId");
